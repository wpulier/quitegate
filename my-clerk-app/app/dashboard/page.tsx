...
const deviceGroups = [
  ...
  },
  {
    ...
    platforms: ["ios"],
    empty: "Install the TestFlight build, sign in, and finish Screen Time plus Safari setup.",
    action: "Install iPhone",
    href: "/download/ios",
  },
  {
    title: "Chrome extension",
    platforms: ["chrome_extension", "chrome"],
    empty: "Install the browser extension so web policy can follow this account.",
      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-12">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg leading-8 text-zinc-600">
              ...
              Safari extension, and browser extension can enforce right now.
            </p>
          </div>
        ...
        <section>
          <div className="mb-4 flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-600">
                Use setup for first install. Use this dashboard to verify
                what is connected after devices check in.
              </p>
            </div>
          </div>
          <div className="grid gap-4 lg:grid-cols-4">
            <SetupLink
              title="Mac"
              description="Desktop policy editing, helper enforcement, browser tuning, and app blocking."
              label="Download Mac"
              href="/download/mac"
            />
            <SetupLink
              title="iOS"
              description="Screen Time app/site blocking, Safari web tuning, policy sync, and connection status."
              label="Install iPhone"
              href="/download/ios"
            />
            <SetupLink
              title="Chrome"
              description="Install the extension when browser policy should follow this account."
              label="Install extension"
              href="/download/chrome"
            />
            <SetupLink
              title="Web"
              description="Guided checklist for account, app installs, Screen Time, Safari, and sync."
              label="Open setup"
              href="/setup"
            />
          </div>
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600">
                Adult blocking is {adultBlocking ? "on" : "off"}. Local Mac
                and iOS values are cached copies. Health reports can prove
        ...
        <section className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-600">
              ...
              capability. iOS status is based on Screen Time setup, Safari
              extension heartbeat, and recent device health.
            </p>
          </div>
