...
final class TortoiseShieldConfigurationExtension: ShieldConfigurationDataSource {
  override func configuration(shielding application: Application) -> ShieldConfiguration {
    makeConfiguration(subtitle: "Tortoise is blocking this app during your active iOS session.")
  }
  ...
  override func configuration(
    ...
    makeConfiguration(subtitle: "Tortoise is blocking this app category during your active iOS session.")
  }
