...
CHROME_INSTAGRAM_TUNER="$APP_PATH/Contents/Resources/ChromeExtension/content/instagram.js"
FIREFOX_INSTAGRAM_TUNER="$APP_PATH/Contents/Resources/FirefoxExtension/content/instagram.js"
